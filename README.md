...
The current stable release is **v1.2.6**. Download
`Lumina_Shader_Lite_v1.2.6.zip` and keep it compressed when installing it.
...
1. Install [Iris](https://www.irisshaders.dev/) or a compatible OptiFine
   version.
2. Download `Lumina_Shader_Lite_v1.2.6.zip` from an official source above.
