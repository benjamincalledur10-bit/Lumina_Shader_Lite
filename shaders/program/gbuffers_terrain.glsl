...
void main() {
    ...
    // Culling Lejano de Follaje para Lumina Lite (64 bloques) - DESACTIVADO (Bug Visual)
    // if ((mat == 10005 || mat == 10009 || mat == 10013 || mat == 10017 || mat == 10021) && length(position.xyz) > 64.0) {
